          ...
          <div className="bg-white rounded-xl shadow-lg p-4">
            ...
            <div 
              className={`w-full h-[334x] md:h-[600px] bg-gray-50 rounded-lg overflow-hidden relative ${
                isVideo ? 'cursor-default' : isDragging ? 'cursor-grabbing' : 'cursor-pointer hover:opacity-90 hover:scale-[1.02]'
              }`}
              ref={viewportRef}
                    ...
                    <div key={index}>
                      ...
                      <div className="flex flex-wrap gap-2">
                        {variation.options.map((option: any, optionIndex: number) => {
                          ...
                          const isDisabled = !optionInStock || optionStock <= 0;
